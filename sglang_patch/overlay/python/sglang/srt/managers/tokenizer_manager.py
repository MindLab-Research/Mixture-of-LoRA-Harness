...
class TokenizerManager(TokenizerControlMixin, TokenizerManagerScoreMixin):
    ...
    def init_lora(self):
        ...
        self._lora_router_hold_ids: List[str] = []
        self._lora_switch_hold_ids_by_rid: Dict[str, List[str]] = {}
        ...
        for i, rid in enumerate(recv_obj.rids):
            ...
            if state.finished:
                ...
                if self.server_args.enable_lora:
                    switch_hold_ids = self._lora_switch_hold_ids_by_rid.pop(rid, [])
                    if switch_hold_ids:
                        asyncio.create_task(self.lora_registry.release(switch_hold_ids))
